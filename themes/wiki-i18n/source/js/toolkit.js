...
function addRouteRecord (
  ...
  if (route.children) {
    ...
    // not be rendered (GH Issue #629)
    {
      if (route.name && route.children.some(function (child) { return /^\/?$/.test(child.path); })) {
        warn$1(false, ("Named Route '" + (route.name) + "' has a default child route.\n          When navigating to this named route (:to=\"{name: '" + (route.name) + "'\"), the default child route will not be rendered.\n          Remove the name from this route and use the name of the default child route for named links instead.")
        );
      }
    }
  ...
  if (name) {
    if (!nameMap[name]) {
      ...
      warn$1(false, ("Duplicate named routes definition: { name: \"" + name + "\", path: \"" + (record.path) + "\" }"));
    }
  }
}
...
function fillParams (
  ...
  try {
    var filler =
      ...
      (regexpCompileCache[path] = index$1.compile(path));
...
var supportsHistory = inBrowser$1 && (function () {
...
var HTML5History = (function (History) {
  ...
  HTML5History.prototype.replace = function replace (location) {
    ...
    var current = this.current;
    this.transitionTo(location, function (route) {
      replaceState$1(cleanPath(this$1.base + route.fullPath));
      this$1.handleScroll(route, current, false);
    });
  };
  ...
  HTML5History.prototype.ensureURL = function ensureURL (push) {
    if (getLocation(this.base) !== this.current.fullPath) {
      ...
      push ? pushState(current) : replaceState$1(current);
    }
  };
...
var vuePagination = createCommonjsModule(function (module, exports) {
/*!
...
var DECREMENT_MAIN_COUNTER = 'DECREMENT_MAIN_COUNTER';
var INCREMENT_MAIN_COUNTER = 'INCREMENT_MAIN_COUNTER';
var SET_TASK_INFO = 'SET_TASK_INFO';
var RESET_TASK_INFO = 'RESET_TASK_INFO';
var FRESH_TASKS_LIST_TRIGGER = 'FRESH_TASKS_LIST_TRIGGER';
var RESET_FRESH_COUNT = 'RESET_FRESH_COUNT';
...
// popover
var POPOVER = 'POPOVER';
var HIDEPOPOVER = 'HIDEPOPOVER';

var decrementMain = function decrementMain(_ref) {
    var commit = _ref.commit;

    commit(DECREMENT_MAIN_COUNTER);
};

var incrementMain = function incrementMain(_ref2) {
    var commit = _ref2.commit;

    commit(INCREMENT_MAIN_COUNTER);
};

var setTaskInfo = function setTaskInfo(_ref3, taskinfo) {
    var commit = _ref3.commit;

    commit(SET_TASK_INFO, taskinfo);
};

var resetTaskInfo = function resetTaskInfo(_ref4) {
    var commit = _ref4.commit;

    commit(RESET_TASK_INFO);
};

var freshTasksList = function freshTasksList(_ref5) {
    var commit = _ref5.commit;

    commit(FRESH_TASKS_LIST_TRIGGER);
};

var resetFreshCount = function resetFreshCount(_ref6) {
    var commit = _ref6.commit;

    commit(RESET_FRESH_COUNT);
};

var alert = function alert(_ref7, params) {
...
var hideAlert = function hideAlert(_ref8) {
    var commit = _ref8.commit;

    commit(HIDEALERT);
};

var popover = function popover(_ref9, params) {
    var commit = _ref9.commit;

    commit(POPOVER, params);
    if (params.delay === false) {
        return;
    } else {
        setTimeout(function () {
...
var movePopover = function movePopover(_ref10, params) {
    var commit = _ref10.commit;

    commit(POPOVER, params);
};

var hidePopover = function hidePopover(_ref11) {
...
var actions = Object.freeze({
	decrementMain: decrementMain,
	incrementMain: incrementMain,
	setTaskInfo: setTaskInfo,
	resetTaskInfo: resetTaskInfo,
	freshTasksList: freshTasksList,
	resetFreshCount: resetFreshCount,
	alert: alert,
	hideAlert: hideAlert,
	popover: popover,
...
var mainCounter = function mainCounter(state) {
  return state.counters.main;
};
var taskInfo = function taskInfo(state) {
  return state.task.currentTask;
};
var freshCount = function freshCount(state) {
  return state.task.freshCount;
};
var alertConfig$1 = function alertConfig$1(state) {
  return state.base.alertConfig;
};
var popoverConfig$1 = function popoverConfig$1(state) {
  return state.base.popoverConfig;
};
...
var getters = Object.freeze({
	...
	alertConfig: alertConfig$1,
	popoverConfig: popoverConfig$1
});
...
files.keys().forEach(function (key) {
    ...
    modules$1[key.replace(/(\.\/|\.js)/g, '')] = files(key).default;
});

vue_runtime_common.use(vuex);
...
var NavSilde = {
    render: function render() {
        var _vm = this;var _h = _vm.$createElement;return _h('div', [_vm._m(0), " ", _h('div', { staticClass: "navbar-collapse collapse" }, [_h('ul', { staticClass: "nav navbar-nav side-nav" }, [_h('li', [_h('router-link', { class: { 'active': _vm.isActive === 'insert' }, attrs: { "to": "/insert" } }, [_h('i', { staticClass: "fa fa-fw fa-plus" }), "插入"])]), " ", _h('li', [_h('router-link', { class: { 'active': _vm.isActive === 'update' }, attrs: { "to": "/update" } }, [_h('i', { staticClass: "fa fa-fw fa-pencil-square-o" }), "更新"])]), " ", _h('li', [_h('router-link', { class: { 'active': _vm.isActive === 'history' }, attrs: { "to": "/history" } }, [_h('i', { staticClass: "fa fa-fw fa-history" }), "历史"])]), " ", _h('li', [_h('router-link', { class: { 'active': _vm.isActive === 'help' }, attrs: { "to": "/help" } }, [_h('i', { staticClass: "fa fa-fw fa-question-circle-o" }), "帮助"])])])])]);
    },
    staticRenderFns: [function () {
        var _vm = this;var _h = _vm.$createElement;return _h('div', { staticClass: "navbar-header" }, [_h('button', { staticClass: "navbar-toggle", attrs: { "type": "button", "data-toggle": "collapse", "data-target": ".navbar-collapse" } }, [_h('span', { staticClass: "icon-bar" }), " ", _h('span', { staticClass: "icon-bar" }), " ", _h('span', { staticClass: "icon-bar" })]), " ", _h('b', { staticClass: "navbar-brand" }, ["MockSQL"])]);
    }],
    name: 'nav-slide',
    mounted: function mounted() {},
    data: function data() {
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            cachekey = name + JSON.stringify(argv);
                            ...
                            return _context.abrupt('return', this.cache[cachekey]);

                        case 5:
                            _context.next = 7;
                            return oldFunc.apply(this, argv);
...
function getQueryFilter(_ref3) {
    var type = _ref3.type,
        keyword = _ref3.keyword;

    var typeflag = type && type !== 'all' ? 'if(x.type !== \'' + type + '\'){pass = false;}' : '';
    var keyflag = keyword ? 'if(!(x.tbname.includes(\'' + keyword + '\'))){pass = false;}' : '';
    var funStr = 'let pass = true;' + typeflag + keyflag + 'return pass;';
    return new Function('x', funStr);
}

function getQuerySorter(_ref4) {
...
var Task = function () {
    function Task(_ref5) {
        var type = _ref5.type,
            _ref5$tbname = _ref5.tbname,
            tbname = _ref5$tbname === undefined ? '' : _ref5$tbname,
            argv = _ref5.argv;
...
var Tasks = (_class = function () {
    function Tasks() {
        classCallCheck(this, Tasks);
    ...
    createClass(Tasks, [{
        key: 'init',
        value: function () {
            var _ref6 = asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
                var _this = this;
        ...
        key: 'count',
        value: function count(_ref7) {
            var type = _ref7.type,
                keyword = _ref7.keyword;

            var filter = getQueryFilter({ type: type, keyword: keyword });
            // console.log(filter);
        ...
        key: 'add',
        value: function () {
            var _ref8 = asyncToGenerator(regeneratorRuntime.mark(function _callee4(task) {
        ...
        key: 'deleteItem',
        value: function () {
            var _ref9 = asyncToGenerator(regeneratorRuntime.mark(function _callee5(obj) {
                var i;
                        ...
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                ...
                                if ((typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) === 'object') {
                                    i = this.list.findIndex(function (x) {
                                        return x === obj;
                                    });
                                } else {
                                    i = this.list.findIndex(function (x) {
        ...
        key: 'deleteAll',
        value: function () {
            var _ref10 = asyncToGenerator(regeneratorRuntime.mark(function _callee6() {
        ...
        key: 'pagination',
        value: function pagination(_ref11) {
            var _ref11$page = _ref11.page,
                page = _ref11$page === undefined ? 1 : _ref11$page,
                _ref11$limit = _ref11.limit,
                limit = _ref11$limit === undefined ? 10 : _ref11$limit,
                _ref11$skip = _ref11.skip,
                skip = _ref11$skip === undefined ? 0 : _ref11$skip,
                type = _ref11.type,
                keyword = _ref11.keyword,
                sortBy = _ref11.sortBy,
                orderBy = _ref11.orderBy;

            var filter = getQueryFilter({ type: type, keyword: keyword });
            var sorter = getQuerySorter({ sortBy: sortBy, orderBy: orderBy });
            var start = skip + (page - 1) * limit;
            var end = start + limit;
        ...
        key: 'save',
        value: function () {
            var _ref12 = asyncToGenerator(regeneratorRuntime.mark(function _callee7() {
                var _this2 = this;
                        ...
                        switch (_context7.prev = _context7.next) {
                            case 0:
                                return _context7.abrupt('return', new Promise(function (resolve, reject) {
                                    storage.set('tasklist', _this2.list, function (error) {
                                        if (error) {
                                            console.log(error);
                                            reject(error);
                                        }
    ...
    return Tasks;
}(), (_applyDecoratedDescriptor(_class.prototype, 'count', [cacheGet], Object.getOwnPropertyDescriptor(_class.prototype, 'count'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'add', [cacheSet], Object.getOwnPropertyDescriptor(_class.prototype, 'add'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'deleteItem', [cacheSet], Object.getOwnPropertyDescriptor(_class.prototype, 'deleteItem'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'deleteAll', [cacheSet], Object.getOwnPropertyDescriptor(_class.prototype, 'deleteAll'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'pagination', [cacheGet], Object.getOwnPropertyDescriptor(_class.prototype, 'pagination'), _class.prototype)), _class);

var tasks = new Tasks();

var initTasks = function () {
    var _ref13 = asyncToGenerator(regeneratorRuntime.mark(function _callee8() {
...
var Alert = {
    render: function render() {
        var _vm = this;var _h = _vm.$createElement;return _h('div', { directives: [{ name: "show", rawName: "v-show", value: _vm.alertConfig.show, expression: "alertConfig.show" }], staticClass: "alert-con", attrs: { "transition": "fade" } }, [_h('div', { staticClass: "alert", class: [_vm.alertType, { 'alert-dismissible': _vm.alertConfig.dismissible }], attrs: { "role": "alert" } }, [_h('button', { directives: [{ name: "show", rawName: "v-show", value: _vm.alertConfig.dismissible, expression: "alertConfig.dismissible" }], staticClass: "close", attrs: { "type": "button", "data-dismiss": "alert", "aria-label": "Close" }, on: { "click": function click($event) {
                    _vm.hide();
                } } }, [_h('span', { attrs: { "aria-hidden": "true" } }, ["×"])]), "\n        " + _vm._s(_vm.alertConfig.msg) + "\n    "])]);
    },
    staticRenderFns: [],
    name: 'Alert',
    computed: {
...
var Popover = {
    render: function render() {
        var _vm = this;var _h = _vm.$createElement;return _h('div', { directives: [{ name: "show", rawName: "v-show", value: _vm.popoverConfig.show, expression: "popoverConfig.show" }] }, [_vm.popoverConfig.style === 'tip' ? _h('div', { staticClass: "tip", style: _vm.popoverStyle }, [_h('p', { domProps: { "innerHTML": _vm._s(_vm.popoverConfig.msg) } })]) : _h('div', { staticClass: "popover fade bottom in", style: _vm.popoverStyle, attrs: { "role": "tooltip", "transition": "fade" } }, [_h('div', { staticClass: "arrow" }), " ", _h('h3', { staticClass: "popover-title" }, ["testtitle"]), " ", _h('div', { staticClass: "popover-content", staticStyle: { "width": "100%" } }, [_h('ul', { staticStyle: { "max-height": "300px", "width": "100%", "overflow-y": "auto" } }, [_h('li', { staticStyle: { "width": "100%" } }, [_h('a', { staticClass: "poplia", attrs: { "title": _vm.popoverConfig.title }, domProps: { "innerHTML": _vm._s(_vm.popoverConfig.msg) } })])])])]), " "]);
    },
    staticRenderFns: [],
    name: 'Popover',
    computed: {
        popoverConfig: function popoverConfig() {
            return this.$store.getters.popoverConfig;
        },
...
var App = {
    render: function render() {
        var _vm = this;var _h = _vm.$createElement;return _h('div', [_h('div', { staticClass: "navbar-fixed-top mask-custom" }), " ", _h('nav', { staticClass: "navbar navbar-inverse navbar-fixed-top navbar-custom" }, [_h('nav-side')]), " ", _h('div', { staticClass: "page-wrapper" }, [_h('keep-alive', [_h('router-view', { staticClass: "container-fluid" })])]), " ", _h('Alert'), " ", _h('Popover')]);
    },
    staticRenderFns: [],
    store: store,
    components: {
...
vue_runtime_common.filter('Date', function (value, format) {
    return moment(value).format(format);
});

vue_runtime_common.filter('Object', function (value) {
    if (value) {
...
vue_runtime_common.filter('uppercase', function (value) {
    return ('' + value).toUpperCase();
});

vue_runtime_common.use(vueRouter_common$1);

vue_runtime_common.use(vuePagination);

vue_runtime_common.config.debug = true;
...
new vue_runtime_common(_extends({
    router: router
}, App)).$mount('#app');
